...
esp_err_t web_server_start(void)
{
    ...
    static const httpd_uri_t routes[] = {
        ...
        /* system: the board itself */
        { .uri = "/api/system/version",         .method = HTTP_GET,  .handler = get_version },
        ...
        { .uri = "/api/calendar/devices",       .method = HTTP_GET,  .handler = get_devices },
        { .uri = "/api/calendar/scan",          .method = HTTP_POST, .handler = post_scan },
        { .uri = "/api/calendar/connect",       .method = HTTP_POST, .handler = post_connect },
        { .uri = "/api/calendar/disconnect",    .method = HTTP_POST, .handler = post_disconnect },
        { .uri = "/api/calendar/forget",        .method = HTTP_POST, .handler = post_forget_device },
        { .uri = "/api/calendar/refresh",       .method = HTTP_POST, .handler = post_refresh },
        { .uri = "/api/calendar/slot",          .method = HTTP_POST, .handler = post_slot },
        { .uri = "/api/calendar/test-image",    .method = HTTP_POST, .handler = post_test },
        { .uri = "/api/calendar/slot/send",     .method = HTTP_POST, .handler = post_slot_send },
        { .uri = "/api/calendar/slot/badge",    .method = HTTP_POST, .handler = post_slot_badge },
        { .uri = "/api/calendar/slot/download", .method = HTTP_GET,  .handler = get_slot_download },

        /* wifi */
        { .uri = "/api/wifi/status",            .method = HTTP_GET,  .handler = get_wifi },
        ...
        /* tesserae: the render service */
        { .uri = "/api/tesserae/status",        .method = HTTP_GET,  .handler = get_tesserae },
